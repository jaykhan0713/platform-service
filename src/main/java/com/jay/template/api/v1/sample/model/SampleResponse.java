...
public record SampleResponse(
        @Schema(description = "Human-readable message.", example = "Sample Endpoint Success")
        String message,

        @Schema(description = "Request id from the incoming request header. Empty when not provided.",
